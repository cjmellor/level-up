...
Leaderboard::by('achievements')->generate();    // Rank by achievements earned (secret ones count)
Leaderboard::by('challenges')->period(Period::Week)->generate(); // Challenges completed this week
